...
{
public:
	Resource(rapidxml::xml_node<>* node, ZipArchive* pZip);
	virtual ~Resource() {}
...
{
public:
	FontResource(rapidxml::xml_node<>* node, ZipArchive* pZip);
	virtual ~FontResource();

public:
	void* GetResource() { return this ? mFont : NULL; }
	int GetHeight() { return gr_ttf_getMaxFontHeight(this ? mFont : NULL); }
	void Override(rapidxml::xml_node<>* node, ZipArchive* pZip);

protected:
	void* mFont;

private:
	void LoadFont(rapidxml::xml_node<>* node, ZipArchive* pZip);
	void DeleteFont();
...
{
public:
	ImageResource(rapidxml::xml_node<>* node, ZipArchive* pZip);
...
{
public:
	AnimationResource(rapidxml::xml_node<>* node, ZipArchive* pZip);
...
public:
	...
	void LoadResources(rapidxml::xml_node<>* resList, ZipArchive* pZip, std::string resource_source);
