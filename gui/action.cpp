...
//#include "../../twinstall.h"
//#include "../openrecoveryscript.h"
//#include "common/partitions.h"
#include "cutils/properties.h"
#include "common/twrp-functions.h"
#include "common/variables.h"
#include "gui/GUIAction.h"
#include "gui/blanktimer.h"
#include "gui/pages.h"
...
int GUIAction::addlog(std::string arg)
{
    operation_start("addlog");
    int i = DataManager::GetIntValue("my_ui_progress");
    if (i++ >= 100)
        i = 0;
    DataManager::SetValue("my_ui_progress", i);
    gui_print("%s [%d]\n", arg.c_str(), i);
    operation_end(0);
    return 0;
}
