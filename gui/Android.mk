...
LOCAL_STATIC_LIBRARIES += libminuitwrp libc libstdc++
LOCAL_WHOLE_STATIC_LIBRARIES += libminzip libselinux libz
#LOCAL_WHOLE_STATIC_LIBRARIES += libminzip
...
ifeq ($(wildcard $(TWRP_THEME_LOC)/ui.xml),)
    $(warning ****************************************************************************)
    $(warning TWRP_THEME_LOC is '$(TWRP_THEME_LOC)')
